...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <a class="btn btn-primary" href="{{ url('admin/dokter/create') }}">Tambah Dokter</a>
    </div>
            ...
            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning ml-1" href="{{ url('admin/dokter/'.$item->id.'/edit') }}"><i class="fas fa-edit"></i></a>
                            <form action="{{ url('admin/dokter/'.$item->id) }}" class="d-inline" method="POST">
                                @method('delete')
                                @csrf
