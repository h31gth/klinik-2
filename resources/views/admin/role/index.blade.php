...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <a class="btn btn-primary" href="{{ url('admin/role/create') }}">Tambah Role</a>
    </div>
            ...
            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->name }}</td>
                        <td>
                            <form method="POST" class="d-inline" action="{{ url('admin/role/'.$item->id) }}">
                                @csrf
                                <a class="btn btn-warning ml-1" href="{{ url('admin/role/'.$item->id.'/edit') }}"><i class="fas fa-edit"></i></a>
